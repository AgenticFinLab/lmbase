"""
Independent test for WeMath dataset loading and formatting.

Checks:
- Registry load for `testmini` split
...
def run():
    """
    Load WeMath `testmini` split and verify standardized and message formats.
    ...
    ds = dataset_registry.get(
        {
            "data_name": "wemath",
            "data_path": "EXPERIMENT/data/wemath",
        },
        "testmini",
    )
    print("Dataset:", ds)
