"""
Independent test for geometry3k dataset loading and formatting.
...
def run():
    """
    Load geometry3k `train` split and verify standardized and message formats.
    ...
    ds = dataset_registry.get(
        {
            "data_name": "geometry3k",
            "data_path": "EXPERIMENT/data/geometry3k",
        },
        "train",
    )
    print("Dataset:", ds)
